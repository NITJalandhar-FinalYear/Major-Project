...
t_directory = "Original Dataset/Emotion Labels"
...
def main():
	...
	print ()
	# Random Sub-Sampling Method implemented (Holdout Sampling with Iterations)
	for i in range(0,no_of_iterations):

		# Splitting the dataset by 80/20 rule i.e. 80% dataset is training & rest 20% for testing
	...
	# print ()
	# print ("Total testing images: ", test_feature.shape[0])
	...
	print ( sum_accuracy / no_of_iterations )
